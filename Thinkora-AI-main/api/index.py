...
# Determine writable directory for DB and uploads in Vercel / serverless environment
...
class SmartAssistant:
    ...
    def _load_knowledge(self):
        paths_to_check = [
            KNOWLEDGE_FILE,
            os.path.join(CURRENT_DIR, "knowledge.json"),
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        # Serving HTML pages if routed directly to function
...
# For local execution or alternative WSGI/HTTP invocation
Handler = handler
